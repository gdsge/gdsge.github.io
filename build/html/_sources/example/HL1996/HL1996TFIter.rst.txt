...
Generally, this alternative algorithm, using the most efficient implementation enabled by procedures above, delivers better performance in computation speed compared to the original algorithm 
in :ref:`Heaton and Lucas (1996) <Heaton and Lucas (1996): Incomplete Markets with Portfolio Choices>`. 
The tradeoff in computation time is that the original algorithm solves a larger system of equations 
...
On the theoretical ground, the original algorithm finds solutions as the limit of a finite-horizon economy 
