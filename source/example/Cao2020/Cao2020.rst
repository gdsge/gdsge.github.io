...
In particular, let :math:`\lambda^h_t` denote the Lagrange multiplier on agent :math:`h` short-sale constraint, then the Euler's equation and complementary-slackness condition should hold in equilibrium:
