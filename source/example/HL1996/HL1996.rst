...
(as a reminder, at each time step, the NFP-KS algorithm solves for consistent future endogenous states policy variables in the inner nest fixing values of policy variables,
