...
not necessarily  a boxed constraint. See example :ref:`Cao and Nie (2017) <CaoNie2017>`, which provides a global solution to a `Kiyotaki-Moore <https://www.journals.uchicago.edu/doi/abs/10.1086/262072>`_ type model, where
...
many models robustly. To see how these issues are addressed very conveniently in the toolbox, see example
