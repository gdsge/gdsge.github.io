...
With the generated files returned by a local or a `remote compiler <http://www.gdsge.com>`_, we can run the *iter_GLSW* procedure to solve the policy iterations,
...
.. code-block:: MATLAB
    ...
    Iter:1453, Metric:9.37357e-09, maxF:9.63784e-09
    Elapsed time is 0.043389 seconds.
...
.. code-block:: MATLAB
    ...
    shock      a1      a2      P1       r  c1_shr
        1  0.3994-0.09986       1 0.01018  0.2006
    Elapsed time is 0.647503 seconds.
...
With some cosmetic modifications we get the following
