************************************************
An Asset Pricing Model with Heterogeneous Agents
************************************************

We use the asset pricing model from Heaton and Lucas (1996) as a leading example for our toolbox.
The model can be solved using either wealth share or consumption share as the endogenous state variable.
The transition equation for either variable is implicit. 
In the case of wealth share, future wealth share depends not only on agents' current portfolio choice but also future prices. However, future prices in turn depends on future wealth share.
Similarly, in the case of consumption share, future consuption share depends on agents' current portfolio choice, future prices, as well as future portfolio choices all depend on future consuption shares.
These implicit transition equations set our alogrithm apart from the existing ones in the literature.
