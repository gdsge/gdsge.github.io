...
It parses the script into excutable files which implements the actual computations (policy function iterations) efficiently in C++, and provides a convenient MATLAB interface to researchers.
